export default {
  'user-login.login.userName': 'Tên đăng nhập',
  'user-login.login.password': 'Mật khẩu',
  'user-login.login.message-invalid-credentials': 'Tên đăng nhập hoặc mật khẩu chưa phù hợp',
  'user-login.login.message-invalid-verification-code': 'Mã xác minh không đúng',
  'user-login.login.tab-login-credentials': 'Credentials',
  'user-login.login.tab-login-mobile': 'Số điện thoại',
  'user-login.login.remember-me': 'Ghi nhớ đăng nhập',
  ...
  'user-login.userName.required': 'Vui lòng nhập tên người dùng!',
  'user-login.password.required': 'Vui lòng nhập mật khẩu!',
